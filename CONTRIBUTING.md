...
1. The preferred way is to create a ticket using the [GCDFO Salmon Ontology tracking system](https://github.com/dfo-pacific-science/dfo-salmon-ontology/issues). This allows you to monitor the progress on work on the issue, and participate in the discussion among the GC DFO Salmon ontology team members.
