...
2. **Set up your development environment**:
   ...
   - See [ROBOT_SETUP.md](./docs/ROBOT_SETUP.md) for detailed setup instructions
...
- Ensure no instance data (i.e., actual, real-world data) are added to the main ontology file

### 3. Quality Control
Before submitting a pull request, run these checks:
```bash
# ROBOT validation
java -jar tools/robot.jar verify --input ontology/dfo-salmon.ttl
...
2. **Ontology modeller**: Ensures proper modeling patterns and conventions
